...
export default function ChangePassword() {
	...
	return (
		<div
			...
			style={{
				background: "radial-gradient(circle at top, #6366F1 0%, #312E81 70%)",
			}}
		>
			<div className="w-full max-w-[360px] bg-white rounded-[24px] p-8 shadow-2xl">
				<button
					className="mb-4 p-2 rounded-lg hover:bg-[#F3F4F6]"
				...
				<p className="text-sm text-[#6B7280] mb-6">
					Confirm with OTP to secure your account.
				</p>
				...
				{featureReady === null ? (
					...
					<div className="space-y-4">
						<p className="text-sm text-[#6B7280]">
							Password change is unavailable for OAuth-only accounts. Add a
							password from account settings first.
						</p>
