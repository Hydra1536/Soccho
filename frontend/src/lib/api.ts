...
export const API_URL =
	import.meta.env.VITE_API_URL || "https://soccho-gateway.onrender.com";
export const AUTH_SCHEME =
	(import.meta.env.VITE_AUTH_SCHEME || "Bearer").trim() || "Bearer";
const AUTO_LOGOUT_ON_AUTH_FAILURE =
	String(
		import.meta.env.VITE_AUTO_LOGOUT_ON_AUTH_FAILURE || "false",
	).toLowerCase() === "true";
...
function setTokens(access: string, refresh?: string): void {
	...
	const normalizedRefresh = normalizeStoredToken(
		typeof refresh === "string" ? refresh : getRefreshToken(),
	);
