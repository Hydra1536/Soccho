...
def conditionally_add_note_field(apps, schema_editor):
    ...
    with schema_editor.connection.cursor() as cursor:
        ...
        Transaction = apps.get_model("transactions", "Transaction")
        schema_editor.add_field(Transaction, Transaction._meta.get_field("note"))
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["friendship_id", "created_at"],
                        name="repay_friend_created_idx",
                    ),
                    models.Index(
                        fields=["payer_id", "created_at"],
                        name="repay_payer_created_idx",
                    ),
                ],
            },
        ),
        migrations.RunPython(
            forward_populate_due_records, backward_cleanup_due_records
        ),
    ]
